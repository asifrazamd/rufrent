...
--
-- Table structure for table `dy_invoice`
--

DROP TABLE IF EXISTS `dy_invoice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dy_invoice` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `Inv_DateTime` varchar(20) NOT NULL,
  `Inv_DueDate` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Inv_Id` (`Inv_Id`),
  KEY `dy_invoice-fk_Tenant_ID_idx` (`Tenant_ID`),
  KEY `dy_invoice-fk_Property_ID_idx` (`Property_ID`),
  CONSTRAINT `dy_invoice-fk_Property_ID` FOREIGN KEY (`Property_ID`) REFERENCES `dy_property` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dy_invoice-fk_Tenant_ID` FOREIGN KEY (`Tenant_ID`) REFERENCES `dy_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dy_invoice`
--

LOCK TABLES `dy_invoice` WRITE;
/*!40000 ALTER TABLE `dy_invoice` DISABLE KEYS */;
/*!40000 ALTER TABLE `dy_invoice` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dy_notifications`
--

DROP TABLE IF EXISTS `dy_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dy_notifications` (
  `Id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `User_Id` (`User_Id`),
  CONSTRAINT `dy_notifications_ibfk_1` FOREIGN KEY (`Notification_Id`) REFERENCES `st_notifications` (`id`),
  CONSTRAINT `dy_notifications_ibfk_2` FOREIGN KEY (`User_Id`) REFERENCES `dy_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dy_notifications`
--

LOCK TABLES `dy_notifications` WRITE;
/*!40000 ALTER TABLE `dy_notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `dy_notifications` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dy_payments_info1`
--

DROP TABLE IF EXISTS `dy_payments_info1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dy_payments_info1` (
  `id` int NOT NULL AUTO_INCREMENT,
  `Payment_Id` varchar(20) NOT NULL,
  `Inv_Id` varchar(20) NOT NULL,
  `Payment_Mode` varchar(100) NOT NULL,
  `Razor_Pay_Order_Id` varchar(50) DEFAULT NULL,
  `Razor_Pay_Payment_ID` varchar(50) DEFAULT NULL,
  `Razor_Pay_Payment_DateTime` varchar(20) DEFAULT NULL,
  `Payment_Status` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Payment_Id` (`Payment_Id`),
  KEY `dy_payments_info1_ibfk_1` (`Inv_Id`),
  CONSTRAINT `dy_payments_info1_ibfk_1` FOREIGN KEY (`Inv_Id`) REFERENCES `dy_invoice` (`Inv_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dy_payments_info1`
--

LOCK TABLES `dy_payments_info1` WRITE;
/*!40000 ALTER TABLE `dy_payments_info1` DISABLE KEYS */;
/*!40000 ALTER TABLE `dy_payments_info1` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table for Property Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `st_notifications` VALUES (1,'Post_Approval','Congratulations Your Property is Approved','Owner','1',1),(2,'Post_Invalid_Input','Please Make Changes to Your Property Inputs','Owner','Weekly',5),(3,'Post_Meeting_Scheduled','Meeting is Scheduled on Date and Time','Owner,Tenant','1',1),(4,'Post_Deal_Finalization','Please Find Invoice : Invoice ID and Kindly Make Payment','Tenant','Daily',5),(5,'Post_Payment_Done','Please Find Reciept: ID and Download it','Tenant','1',1),(6,'Post_Service_Req_Complete','Your Service Request is complete, Please Check in your Profile Section for Getting Information','User','1',1),(7,'Refer_Earn','Please Refer and Earn Coins','User','Monthly',1),(8,'Offer_RollOut','New Offer','User','1',1);
...
BEGIN
    ...
    IF startDate > endDate THEN
        ...
        SET MESSAGE_TEXT = 'startDate cannot be later than endDate.';
    END IF;
    ...
    -- Ensure endDate is always the last day of the year for "yearly" report
    IF reportType = 'yearly' AND MONTH(endDate) < 12 THEN
        SET endDate = CONCAT(YEAR(endDate), '-12-31');
    END IF;
    ...
    -- Dynamically generate the list of years between startDate and endDate
    ...
    ELSEIF reportType = 'weekly' THEN
        SET queryText = CONCAT(
            ...
            'SELECT 7 UNION ALL SELECT 8 UNION ALL SELECT 9 UNION ALL ',
            'SELECT 10 UNION ALL SELECT 11 UNION ALL SELECT 12) AS months ',
            'CROSS JOIN (SELECT 1 AS week UNION ALL SELECT 2 UNION ALL SELECT 3 UNION ALL ',
            'SELECT 4 UNION ALL SELECT 5) AS weeks '
        );
        ...
        SET queryText = CONCAT(
            ...
            'LEFT JOIN ', tableName, ' t ON YEAR(t.', dateField, ') = years.year ',
            'AND MONTH(t.', dateField, ') = months.month ',
            'AND WEEK(t.', dateField, ', 1) - WEEK(DATE_SUB(t.', dateField, ', INTERVAL DAYOFMONTH(t.', dateField, ') - 1 DAY), 1) + 1 = weeks.week ',
            'AND t.', dateField, ' >= "', startDate, '" AND t.', dateField, ' <= "', endDate, '" '
        );

        -- Adjust the WHERE clause for weekly report
        SET queryText = CONCAT(
            queryText,
            'WHERE (years.year > YEAR("', startDate, '") OR (years.year = YEAR("', startDate, '") AND months.month >= MONTH("', startDate, '"))) ',
            'AND (years.year < YEAR("', endDate, '") OR (years.year = YEAR("', endDate, '") AND months.month <= MONTH("', endDate, '"))) '
        ...
        SET queryText = CONCAT(
            queryText,
            ' GROUP BY years.year, months.month, weeks.week ',
            ' ORDER BY years.year, months.month, weeks.week'
        );
...
-- Dump completed on 2025-02-03  9:09:59
